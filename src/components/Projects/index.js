    ...
    <Container id='projects' >
        <Wrapper>
            ...
            <ToggleGroup>
                ...
                <Divider/>
                {toggle === "web app" ? (
                <ToogleButton active onClick={()=> setToggle("web app")}>Web</ToogleButton>
                ) : (
                <ToogleButton onClick={()=> setToggle("web app")}>Web</ToogleButton>
                )}
                <Divider/>
                {toggle === "android app" ? (
                <ToogleButton active onClick={()=> setToggle("android app") } >Design</ToogleButton>
                ) : (
                <ToogleButton onClick={() => setToggle("android app")}>Design</ToogleButton>
                )}
            </ToggleGroup>
            <CardContainer>
